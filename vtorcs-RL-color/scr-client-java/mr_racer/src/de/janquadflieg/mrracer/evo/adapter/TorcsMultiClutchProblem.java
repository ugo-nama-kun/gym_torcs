...
extends Problem implements ParallelEvaluableProblem{
    ...
    public Evaluation evaluate(Individual variables, int offset) {
        ...
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.GROWTH_RATE_B,
                String.valueOf(Math.pow(10, v.toDouble())));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_M");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.M,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_V");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.V,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_Q");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.Q,
                String.valueOf(v.toDouble()));

        // parameters for the clutch, 2nd gear
        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_B");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.GROWTH_RATE_B,
                String.valueOf(Math.pow(10, v.toDouble())));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_M");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.M,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_V");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.V,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_Q");
        params.setProperty(MrRacer2011.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.Q,
                String.valueOf(v.toDouble()));
